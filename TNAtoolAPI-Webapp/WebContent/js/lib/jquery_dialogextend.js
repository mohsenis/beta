(function() {
  ...
  $.widget("ui.dialogExtend", {
    ...
    _initButtons: function() {
      ...
      buttonPane.append('<a class="ui-dialog-titlebar-restore ui-corner-all ui-state-default" title="Extend" href="#"><span class="ui-icon ' + this.options.icons.restore + '">restore</span></a>').find('.ui-dialog-titlebar-restore').attr("role", "button").mouseover(function() {
    ...
    _initModuleButton: function(name, mode) {
      ...
      return buttonPane.append('<a class="ui-dialog-titlebar-' + name + ' ui-corner-all ui-state-default" id="'+name+'" href="#"><span class="ui-icon ' + this.options.icons[name] + '">' + name + '</span></a>').find(".ui-dialog-titlebar-" + name).attr("role", "button").mouseover(function() {
        return $(this).addClass("ui-state-hover");
      }).mouseout(function() {
        return $(this).removeClass("ui-state-hover");
      }).focus(function() {
  ...
  $.extend(true, $.ui.dialogExtend.prototype, {
    ...
    _initStyles_maximize: function() {
      ...
      if (!$(".dialog-extend-maximize-css").length) {
        ...
        style += '.ui-dialog .ui-dialog-titlebar-maximize { width: 19px; height: 18px; title: "maximize";}';
