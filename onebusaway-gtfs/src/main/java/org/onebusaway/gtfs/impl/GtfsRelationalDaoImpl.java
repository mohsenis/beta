...
public class GtfsRelationalDaoImpl extends GtfsDaoImpl implements
  ...
  private Map<String, List<Stop>> _stopsByAgency = null;
  
  private Map<String, List<Stop>> _stopsByRoute = null;
...
/*  //@Override
  public List<Stop> getStopsForAgency(String id) {
	    if (_stopsByAgency == null)
	      _stopsByAgency = mapToValueList(getAllStops(), "agencyId", String.class);
	    return list(_stopsByAgency.get(id));
	  }
//@Override
  public List<Stop> getStopsForRoute(String agency, String route) {
	    if (_stopsByRoute == null)
	      _stopsByRoute = mapToValueList(getAllStops(), "agencyId", String.class);
	    return list(_stopsByRoute.get(id));
	  } */
